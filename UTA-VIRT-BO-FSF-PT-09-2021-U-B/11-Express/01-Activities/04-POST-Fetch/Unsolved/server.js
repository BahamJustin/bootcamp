...
app.post("/api/reviews", (req, res) => {
  ...
  // destructures the response into a json object
  ...
  // if even 1 of these properties dont exist, a new review is not created
  if (product && review && username) {
    ...
    // if a new review cannot be created, show error
